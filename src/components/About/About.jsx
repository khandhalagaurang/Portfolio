    ...
    return (
        ...
        <div className='container'>
            ...
            <div className='About row  d-flex justify-content-center gap-md-3 gap-3'>
                <div className='col-lg-4 col-md-5 col-9 d-flex justify-content-center'>
                    <img src={img2} alt="" className='img2 img-fluid rounded-3' />
                </div>
                <div className=' d-flex flex-column gap-2 col-lg-7 col-md-10 col-11'>
